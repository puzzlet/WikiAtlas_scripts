check_existence: countries.json subunits.json places.json
...
subunits.json: ne_10m_admin_1_states_provinces_shp
	ogr2ogr -f GeoJSON -where "admin IN ('noFrance')" subunits.geo.json ne_10m_admin_1_states_provinces_shp.shp
places.json: ne_10m_populated_places.shp	
	ogr2ogr -f GeoJSON -where "ADM0NAME = 'Egypt' OR ADM0NAME = 'Iran' OR SOV0NAME = 'Saudi Arabia' OR SOV0NAME = 'Lebanon' OR SOV0NAME = 'Turkey' OR SOV0NAME = 'Syria' OR SOV0NAME = 'Iraq' OR ISO_A2 = 'noFR' AND POP_MAX > '200000'" places.geo.json ne_10m_populated_places.shp
